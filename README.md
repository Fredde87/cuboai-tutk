...
Download the files from the [GitHub repository](https://github.com/Fredde87/cuboai-tutk)
or clone the repository:
```bash
git clone https://github.com/Fredde87/cuboai-tutk.git
cd cuboai-tutk
...
- [getcubo](https://github.com/niruse/cuboai) — original CuboAI HA integration that inspired this project
